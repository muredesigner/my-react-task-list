...
/* este componente renderiza una tarea con un checkbox para marcarla como completada o no, una tarea que puede ser editada al hacer clic en él y un botón para eliminar la tarea */